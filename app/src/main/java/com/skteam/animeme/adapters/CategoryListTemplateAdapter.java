...
public class CategoryListTemplateAdapter extends RecyclerView.Adapter<CategoryListTemplateAdapter.ImageViewHolder> {
    Context mContext;
    List<Image> mList;

    public CategoryListTemplateAdapter(Context context, List<Image> list) {
        mContext = context;
        mList = list;
    }
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("categoryType","templateCategory");
